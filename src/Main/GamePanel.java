...
public class GamePanel extends JPanel implements Runnable{
	...
	public GamePanel() {
		...
		try {
			mainFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/res/ColdSnowflake-Twelve.ttf"));
			coolFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/res/ColdSnowflake-Nine.ttf"));
	...
	public void paintComponent(Graphics g) {
		...
		switch(gameState){
			case titleScreen:
				...
				g2.setFont(g2.getFont().deriveFont(Font.PLAIN, 120));
				...
				g2.drawString("Highscore: " + highS.highscore, 10, 30);
